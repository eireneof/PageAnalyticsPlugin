...
import ExtractionData, { ExtractionDataValidator } from '../models/extractionData'
...
export const collectData = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
